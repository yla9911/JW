...
public class BroadcastCommandParser implements CommandParser {
    ...
    private final String DELETEINFO="deleteinfo";
...
//                          sendMessage(msg);
              ...
              //this is a test  
                ...
                else if(command.equalsIgnoreCase(DELETEINFO))
                	deleteInfo(cc);
            }
        } catch(Exception e) {
    ...
    private void deleteInfo(ConnectedClient cc) {
    	ds.deleteInfo(cc.getNick());
    }

...
public class ChatClient extends JFrame implements KeyListener, ActionListener, FocusListener,ListSelectionListener {
	 ...
	 public static final String downloadDirec = "file:///D:\\tmp/";   //文件下载本地路径
    ...
    JButton buttonConnect, buttonSend, buttonSendFile,buttonAdd,buttonAccept,buttonSave;   //增加发送文件按钮;
   ...
   */
    ...
    public void uiInit() {
      ...
      //新按钮和JFilechooser
        ...
        southPanel.add(buttonSendFile = new JButton("Select File"));
...
//        JOptionPane.showMessageDialog(this, "提示消息", "标题",JOptionPane.WARNING_MESSAGE);  
 ...
 //       historyWindow.addText(str);
    	...
    	String fileType = strLen >= 4 ? str.substring(strLen-4) : "";
    	
    	if(fileType.equals(".jpg") || fileType.equals(".JPG") 
    			|| fileType.equals(".png") || fileType.equals(".PNG")
    			|| fileType.equals("jpeg") || fileType.equals("JPEG")) {       //图片文件的处理
    		int directoryIndexStart = str.indexOf(":")+1;
    		historyWindow.addFigure(str.substring(0, directoryIndexStart), str.substring(directoryIndexStart));
    	} else {
    		historyWindow.addText(str);   //文字或其他文件的处理
    	}
  ...
  //          JOptionPane.showMessageDialog(null, txtNick.getText(), txtNick.getText(), JOptionPane.ERROR_MESSAGE);
            if(ck.isConnected()) {
                ...
                ck.sendMessage("/online");//上线，向好友发送信息
            } else {
 ...
 // new method to send file
    private void sendFile() {
    	fileChooser.setFileSelectionMode(0);
    	/* 
    	 * Detect the operation after opening the file choosing panel,
    	 * Clicking on the cancel button will return 1 to status
    	 */
...
//    		System.out.print(file.getAbsolutePath());
    		boolean test=ck.sendFile(file.getAbsolutePath());
 //   		System.out.println(test);
    		if(test) {
    			String fileName = file.getName();
    			int fileNameLen = fileName.length();
    			String fileExt = file.getName().substring(fileNameLen-4);
    			if((fileExt.equals(".jpg") || fileExt.equals(".JPG")
    					|| fileExt.equals(".png") || fileExt.equals(".PNG")
    					|| fileExt.equals("jpeg") || fileExt.equals("JPEG"))) {
    				String parsedMsg = "<a href='" + downloadDirec + fileName + "'>There is a new file sent to the group, please click this link to view.</a>";
    				System.out.println("form true: "+parsedMsg);
    				ck.sendMessage(parsedMsg);
    			} else {
    				
    				String parsedMsg = downloadDirec + fileName;
    				System.out.println("form else:"+ parsedMsg );
    				ck.sendMessage(parsedMsg);
    			}
    ...
    public void keyTyped(KeyEvent e) {
        if(e.getKeyChar() ==KeyEvent.VK_ENTER) {
            ...
            // 2020-07-06 Add new feature: select file from system
            if(e.getSource()==buttonSendFile) sendFile();
    ...
    class ClientHistory extends JEditorPane {
        ...
        public void addText(String str) {
            ...
            historyWindow.addHyperlinkListener(new HyperlinkListener() {
                public void hyperlinkUpdate(HyperlinkEvent e) {
                  if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
                    try {
                      String command = e.getURL().toString().substring(5);
                      System.out.println("Direc: "+e.getURL());
                      Runtime.getRuntime().exec("explorer.exe D:\\temp");
//                      Runtime.getRuntime().exec("D:\\temp\\2.jpg");
                    }
                    catch (Exception ex) {
                      ex.printStackTrace();
                    }
        ...
        public void addFigure(String nickName, String url) {       //在对话框中显示图片
        	setText("<html>" + nickName + "<img src="+url+" width=250 height=200></img></html>");
//                System.out.println("<html>" + nickName + "<a href=" + url + ">" + "<img src="+url+" width=250 height=200></img></a></html>");
        }
